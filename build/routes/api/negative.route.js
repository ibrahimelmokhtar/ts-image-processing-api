...
const negative_schema_1 = __importDefault(require("../../schemas/negative.schema"));
...
const process_negative_1 = __importDefault(require("../../modules/process-negative"));
// create an express route:
const negativeRoute = express_1.default.Router();
// process GET requests for '/negative' route:
negativeRoute.get('/negative', negative_schema_1.default, validator_middleware_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log('\ninside (/negative) route ...');
    // set the desired parameters:
    const fileName = req.query.filename;
    // construct the new filename:
    const newFileName = (0, img_create_name_1.default)(fileName, { keyword: 'negative' });
    ...
    if (isProcessedImageFound) {
        ...
        (0, process_negative_1.default)(fileName, newFileName);
    }
